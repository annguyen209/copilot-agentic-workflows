...
Imported from [`Kotlin/kotlin-agent-skills`](https://github.com/Kotlin/kotlin-agent-skills),
original skill:
[`skills/kotlin-tooling-agp9-migration`](https://github.com/Kotlin/kotlin-agent-skills/tree/main/skills/kotlin-tooling-agp9-migration).

This local copy keeps the original supporting materials in:
